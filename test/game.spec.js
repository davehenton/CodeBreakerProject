...
describe('Calculator', () => {
  ...
  it('should set the `value` of element `answer` to empty string', () => {
    $('#answer').value.should.equal('');
  });

  describe('setHiddenFields()', () => {
    it('should set the `value` of element `answer` to a random whole number between 0 and 9999. @randomNumber', () => {
    ...
    it('should set the `value` of element `answer` to a number exactly 4 characters long. @answerLength', () => {
      var array = [];
    ...
    it('should set the `value` of element `attempt` to 0. @setAttempt', () => {
      $('#guess').click();
      assert($('#attempt').value === '0', 'The `value` of element `attempt` was "' + $('#attempt').value + '" which is not 0.');
    });
    it('should only run if the `value` of elements `attempt` or `answer` are empty. @preventClearing', () => {
      $('#guess').click();
  ...
  describe('setMessage()', () => {
    it('should set element `message` to incorrect string value message. @setMessage', () => {
      $('#guess').click();
    ...
    it('should set element `message` to incorrect value message. @setMessage', () => {
    ...
    it('should set element `message` to winning message. @setMessage', () => {
      $('#guess').click();
    ...
    it('should set element `message` to loosing message. @setMessage', () => {
  ...
  describe('validateInput()', () => {
    it('should accept one parameter and return `true` only when that parameter\'s `length` is 4. @validateInput', () => {
      $('#user-guess').value = '0000';
      $('#guess').click();
    ...
    it('should run when `guess` runs @runValidation', () => {
      var attempt = $('#attempt');
  ...
  describe('showAnswer()', () => {
    it('should accept one parameter and set the `innerHTML` of element `code` to match element `answer`\'s value. If parameter is `true` element `code` should have ` success` added to it\'s `className`. (Note: the spaces before ` success`) @showAnswer', () => {
      var code = $('#code');
      var answer = $('#answer');
      // test true
      var guess = $('#guess');
    ...
    it('should accept one parameter and set the `innerHTML` of element `code` to match element `answer`\'s value. If parameter is `false` element `code` should have ` failure` added to it\'s `className`. (Note: the spaces before ` failure` are required) @showAnswer', () => {
      var code = $('#code');
      // test false
      $('#user-guess').value = '0000';
  ...
  describe('showReplay()', () => {
    it('should set element `guessing-div`\'s `style` to "display:none" element `replay-div`\'s `style` to "display:block" if win. @showReplay', () => {
      var guess = $('#guess');
      guess.click();
      $('#user-guess').value = $('#answer').value;
      guess.click();
    ...
    it('should set element `guessing-div`\'s `style` to "display:none" element `replay-div`\'s `style` to "display:block" if lost. @showReplay', () => {
  ...
  describe('reset()', () => {
    ...
    it('should set the answer value to zero. @reset', () => {
      assert($('#answer').value === '', '`answer.value` was not set to an empty string.');
    });
    it('should set the message to empty string. @reset', () => {
      assert($('#attempt').value === '', '`attempt.value` was not set to to an empty string.');
    });
    it('should reset guesses and results. @reset', () => {
      assert($('#results').children.length === 1, 'the results and guesses column html where not removed from the dom');
    });
    it('should set element `guessing-div`\'s `style` to "display:block" element `replay-div`\'s `style` to "display:none" if lost. @reset', () => {
      assert($('#guessing-div').className.split(' ').indexOf('hidden') === -1, '`guessing-div`\'s `class` was not set to "hidden" class.');
      assert($('#replay-div').className.split(' ').indexOf('hidden') !== -1, '`replay-div`\'s `class` was not set to "display:block".');
    });
  });
